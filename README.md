...
FZ3有两个版本，区别在于内存的容量和位宽上，FZ3A一共2GB大小的DDR，位宽32bit；FZ3B一共4GB大小的DDR，位宽64bit，很多二手卖家也不太关注这个细节，商品展示界面配的图也是不对的，不过分辨起来还是比较容易的，主要是看实物照片SD卡槽的位置，在正面的就是2GB的FZ3A版本，在背面的就是4GB的FZ3B版本，黑金官方针对这两个版本都有对应资料，例程上都有一个配置了PS与一个AXI-GPIO的小工程，使用的是Vivado18.3版本
